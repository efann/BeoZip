...
public class SelectFilesChooser implements ActionListener
{
  ...
  static private final JFileChooser foChooser = new JFileChooser();
  ...
  // ---------------------------------------------------------------------------
  public SelectFilesChooser(final MainFrame toMainFrame)
  {
  ...
  {
    // Go ahead and allow hidden files/directories to be shown and then let
    // the FileFilter decide what to show.
    SelectFilesChooser.foChooser.setFileHidingEnabled(false);
    // If you don't set this to false, then you will see 2 file filters listed:
    // the default choose all and your file filter.
    SelectFilesChooser.foChooser.setAcceptAllFileFilterUsed(false);
  }

  // ---------------------------------------------------------------------------
  public SelectFileReturnValue selectFileDialog(final String tcStartFolder, final int tnFileSelectionMode, final boolean tlMultiSelection,
                                                final boolean tlHiddenDirectories, final boolean tlHiddenFiles, final boolean tlZipFilesOnly, final String tcTitle, final String tcButtonLabel,
                                                final int tnAccessoryType)
  {
